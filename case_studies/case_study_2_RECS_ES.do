*-------------------------------------------------------------------------------*
* Stats 506, F18 RECS case study
* RECS (case_study_2_RECS_ES.do)
*
...
*cd ~/Stats506_F18/case_studies/ 	// Working directory

// Windows path for MiDesktop
*cd \\afs\umich.edu\users\j\b\jbhender\Stats506_F18\case_studies
