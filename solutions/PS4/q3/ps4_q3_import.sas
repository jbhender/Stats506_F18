/* Import 2016 Medicare provider PUF file.
 * PS4, Q3 
 * Stats 506, F18
 * 
 * Original Data 
...
/* Library: ----------------------------------------------------------------- */
libname saslib '/home/jbhender/ps4q3';

/* Import data: ------------------------------------------------------------- */
DATA saslib.Medicare_PS_PUF;
	LENGTH
		npi              					$ 10
	...
	INFILE '/home/jbhender/ps4q3/Medicare_Provider_Util_Payment_PUF_CY2016.txt'
